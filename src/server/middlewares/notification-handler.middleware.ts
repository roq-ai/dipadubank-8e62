...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderPlaced.create': { roles: ['owner', 'end-customer'], key: 'order_placed', tenantPath: [], userPath: [] },
  'PaymentReceived.update': { roles: ['owner'], key: 'payment_received', tenantPath: [], userPath: [] },
  'OrderDelivered.update': { roles: ['owner', 'end-customer'], key: 'order_delivered', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['owner', 'end-customer'];
