...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`DipaDuBank`}</title>

        <meta
          name="description"
          content="Welcome to DipaDuBank, your go-to platform for innovative crypto banking solutions. Experience banking like never before, secure, efficient, and cool!"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1621504450181-5d356f61d307?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjcnlwdG98ZW58MHx8fHwxNjk1MzI2MTQyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@artrachen?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Art Rachen`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to DipaDuBank, your go-to platform for innovative crypto banking solutions. Experience banking like never before, secure, efficient, and cool!`}
            </Text>
            <Box
